...
import mac1 from "https://i.ibb.co/nnVYTtX/Screenshot-2024-07-04-205755.png";
  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="dark:text-white text-neutral-800 text-3xl font-bold mb-20 text-center w-full"
      >
        {title || (
          <span>
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src={mac1}
          alt="https://i.ibb.co/nnVYTtX/Screenshot-2024-07-04-205755.png"
          fill
